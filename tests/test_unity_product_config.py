...
class UnityProductConfigTests(unittest.TestCase):
    ...
    def test_scene_face_tracking_uses_stable_jitter_defaults(self):
        tracker = FACE_TRACKER.read_text(encoding="utf-8")
        self.assertIn("CurrentSettingsVersion = 16", tracker)
        ...
        self.assertIn("GlobalTrackingLateralBalanceSettingsVersion = 16", tracker)
        ...
        self.assertIn("StableGlobalTrackingLateralMeters = 0.4f", tracker)
        self.assertIn("StableCameraYawOrbitStrength = 1.15f", tracker)
    ...
    def test_scene_face_tracking_has_optional_global_tracking_mode(self):
        ...
        self.assertIn("sceneFaceTracker.globalTrackingLateralMeters = 0.4f", builder)
        ...
        self.assertIn("globalTrackingLateralMeters: 0.4", scene)
        self.assertIn("cameraYawOrbitStrength: 1.15", scene)
