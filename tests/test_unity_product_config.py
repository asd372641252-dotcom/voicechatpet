...
class UnityProductConfigTests(unittest.TestCase):
    ...
    def test_scene_face_tracking_uses_stable_jitter_defaults(self):
        tracker = FACE_TRACKER.read_text(encoding="utf-8")
        self.assertIn("CurrentSettingsVersion = 17", tracker)
        ...
        self.assertIn("StableGlobalTrackingLateralMeters = 0.25f", tracker)
        self.assertIn("StableCameraYawOrbitStrength = 1.35f", tracker)
    ...
    def test_scene_face_tracking_has_optional_global_tracking_mode(self):
        ...
        self.assertIn("sceneFaceTracker.globalTrackingLateralMeters = 0.25f", builder)
        ...
        self.assertIn("globalTrackingLateralMeters: 0.25", scene)
        self.assertIn("cameraYawOrbitStrength: 1.35", scene)
