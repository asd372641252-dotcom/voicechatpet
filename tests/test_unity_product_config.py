...
class UnityProductConfigTests(unittest.TestCase):
    ...
    def test_scene_face_tracking_uses_stable_jitter_defaults(self):
        tracker = FACE_TRACKER.read_text(encoding="utf-8")
        self.assertIn("CurrentSettingsVersion = 11", tracker)
        self.assertIn("StableTrackingDefaultsSettingsVersion = 7", tracker)
        self.assertIn("GlobalTrackingSensitivitySettingsVersion = 11", tracker)
        ...
        self.assertIn("StableGlobalTrackingHeightMeters = 0.45f", tracker)
        self.assertIn("StableGlobalTrackingDepthMeters = 0.275f", tracker)
    ...
    def test_scene_face_tracking_has_optional_global_tracking_mode(self):
        ...
        menu = CONTEXT_MENU.read_text(encoding="utf-8")
        self.assertIn("SetGlobalTrackingEnabled", menu)
        ...
        self.assertIn("sceneFaceTracker.globalTrackingHeightMeters = 0.45f", builder)
        self.assertIn("sceneFaceTracker.globalTrackingDepthMeters = 0.275f", builder)
        ...
        self.assertIn("globalTrackingHeightMeters: 0.45", scene)
        self.assertIn("globalTrackingDepthMeters: 0.275", scene)
